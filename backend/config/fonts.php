...
| "cyrillic" records whether the family actually ships a Cyrillic subset.
| Seven of these do not, and a portfolio written in Russian would silently
| fall back to a system font for every glyph. The flag reaches the editor so
| the font picker can say so instead of letting the design quietly break.
|
*/
